# Temple CIS: Machine Learning Final Project: House Prices
...
In order to access this project EDA, pull ML_Final_EDA.ipynb and open the file using Anaconda Jupyter. 

The current features that we are using are the following (This is prone to change):
